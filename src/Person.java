public class Person {
    ...
    //this is a default constructor created by the computer, it has no arguments in it
    public Person(){
    }
    // This is the constructor created by ourself
    // (This constructor was created first but the computer insisted we create a default constructor
...
class Ceo extends Person{
   ...
   //create fire method
    public String fireStaffAndIncreasePay(Staff staff1){
...
// create an attendance method for staff
    public String markAttendance(int daysPresent){
        if(daysPresent>=30){
